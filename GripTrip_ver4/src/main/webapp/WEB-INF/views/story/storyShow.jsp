			...
			<div class="single-blog" id="storyDetail">
				<div class="post-thumb">
					<c:if test="${story.storyPictureUrl!=null}">
						<img src="upload/${story.storyPictureUrl}"
						...
						<div class="post-overlay">
							<c:choose>
								<c:when test="${story.storyTripDate==null}">
									...
									<br>
									<br> <font style="color: white;" class="storyDate">&nbsp;${story.storyCreateDate}</font></span>
								</c:when>
								<c:otherwise>
									<span class="uppercase"> <br>
									<br>
									<br> <font style="color: white;">&nbsp;${story.storyTripDate}</font></span>
								</c:otherwise>
							</c:choose>
						</div>
					</c:if>
				...
				<div class="post-content overflow">
					...
					<h5 class="post-author">
						<font style="color: #0099ae; font-family: 'Jeju Gothic';">Posted
							by ${nickname}</font>
					</h5>
					<c:if test="${story.storyLocation!=null}">
                      at ${story.storyLocation}<br>
					</c:if>
					<br> ${fn:replace(story.storyContent, cn, br)}
					...
					<div class="post-bottom overflow">
						<ul class="nav navbar-nav post-nav">
							<c:if test="${sessionScope.mvo.email!=null}">
								<li style="color: #0099ae;"
									onclick="bookmark(${story.book.book_no},${story.storyNo})"
									id="bookmarkInsert"><i class="fa fa-bookmark-o"></i>&nbsp;&nbsp;bookmark</li>
								<li style="color: #0099ae;"
									onclick="deleteBookmark(${story.book.book_no},${story.storyNo})"
									id="bookmarkDelete"><i class="fa fa-bookmark"></i>&nbsp;&nbsp;bookmark</li>
							</c:if>
							<li><font style="color: #0099ae;">${story.storyHit}
									hits</font></li>
							<li style="color: #0099ae;"><i class="fa fa-comments"></i>&nbsp;&nbsp;${countComment}
								Comments</li>
							<c:if test="${sessionScope.mvo.email==story.member.email}">
								<li><a href="#" id="storyUpdateBtn"><i
										class="fa fa-pencil"></i>수정</a></li>
								<li><a href="#" id="storyDeleteBtn"><i
										class="fa fa-trash"></i>삭제</a></li>
								<c:if test="${story.storyIsPublic=='private'}">
									<li><i class="fa fa-lock" aria-hidden="true"
										style="color: #0099ae;"></i></li>
								</c:if>
							</c:if>
							<li><a href="#" id="storyListBtn"><i class="fa fa-undo"></i>Story
									List</a></li>
						</ul>
					</div>
					<br>
												...
												<div class="all-comment">
													<div class="post-comment"
														...
														<c:choose>
															<c:when test="${comment.depth==0}">
																<span class="media-body"> <span><i
																		class="fa fa-user"></i>Posted by <a href="#">${comment.member.nickname}</a></span>
																	<p id="comment">
																	...
																	<ul class="nav navbar-nav post-nav">
																		...
																		<li><a class="recommentA"><i
																				class="fa fa-reply"></i>Reply</a></li>
																		<c:if
																			test="${comment.member.email == sessionScope.mvo.email}">
																			<li><a class="commentUpdateA"><i
																					class="fa fa-pencil"></i>수정</a></li>
																			<li><a
																				href="removeComment.do?commentNo=${comment.commentNo}&&storyNo=${comment.story.storyNo}&&book_no=${story.book.book_no}"><i
																					class="fa fa-trash"></i>삭제</a></li>
																		</c:if>
																	</ul>
																</span>
																...
																<div class="media-body">
																	...
																	<div class="col-md-11">
																		<span><i class="fa fa-user"></i>Posted by <a
																			href="#">${comment.member.nickname}</a></span>
																		<p id="comment">
																			<c:if test="${comment.commentIsPublic=='private'}">
																				<a href="#"> <i class="fa fa-lock"
																					aria-hidden="true"></i>
																		...
																		<ul class="nav navbar-nav post-nav">
																			<li><a href="#"><i class="fa fa-clock-o"></i>${comment.commentCreateDate}</a></li>
																			<li><a class="recommentB"><i
																					class="fa fa-reply"></i>Reply</a></li>
																			<c:if
																				test="${comment.member.email == sessionScope.mvo.email}">
																				<li><a class="commentUpdateB"><i
																						class="fa fa-pencil"></i>수정</a></li>
																				<li><a
																					href="removeComment.do?commentNo=${comment.commentNo}&&storyNo=${comment.story.storyNo}&&book_no=${story.book.book_no}"><i
																						class="fa fa-trash"></i>삭제</a></li>
													...
													<div class="updateComment">
														<form action="updateComment.do" method="post">
															<input type="hidden" name="storyNo"
																value="${story.storyNo}"> <input type="hidden"
																name="commentNo" value="${comment.commentNo}"> <input
																type="hidden" name="book_no"
																value="${story.book.book_no}">

															<div class="comments">
																<div class="row" style="width: 700px;">
																	<div class="col-md-2">${comment.member.nickname}
																	</div>
																	<div class="col-md-10">
																		<div class="comment1">
																			<textarea name="commentContent" rows="3" cols="63"
																				style="border-style: hidden;"></textarea>
																		</div>
																		<c:choose>
																			<c:when test="${comment.commentIsPublic == 'public'}">
																				<div style="margin: 12px; margin-left: 20px;">
																					<input type="radio" name="commentIsPublic"
																						value="public" checked />&nbsp;공개 &nbsp;&nbsp; <input
																						type="radio" name="commentIsPublic"
																						value="private" />&nbsp;비공개
																				</div>
																			</c:when>
																			<c:otherwise>
																				<div style="margin: 12px; margin-left: 20px;">
																					<input type="radio" name="commentIsPublic"
																						value="public" />&nbsp;공개 &nbsp;&nbsp; <input
																						type="radio" name="commentIsPublic"
																						value="private" checked />&nbsp;비공개
																				</div>
																			</c:otherwise>
																		</c:choose>
																		<div style="margin-left: 346px; margin-top: -45px;">
																			<input class="btn btn-common updateCommentBtn"
																				type="submit" value="수정"
																				style="width: 100px; background: white;"> <input
																				class="btn btn-common cancelUpdateCommentBtn"
																				value="취소" style="width: 100px; background: white;">
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="reComment">
														<form action="writeRecomment.do" method="post"
															class="recommentFrm">
															<input type="hidden" name="lineNo" value="${i.index}">
															<input type="hidden" name="storyNo"
																value="${comment.story.storyNo}"> <input
																type="hidden" name="parentCommentNo"
																value="${comment.commentNo}"> <input
																type="hidden" name="parentCommentEmail"
																value="${comment.member.nickname}"> <input
																type="hidden" name="groupId" value="${comment.groupId}">
															<input type="hidden" name="orderId"
																value="${comment.orderId}"> <input type="hidden"
																name="depth" value="${comment.depth}">
															<div class="comments">
																<div class="row">
																	<div class="col-md-1">re:</div>
																	<div class="col-md-11">
																		<div class="comment1">
																			<textarea name="commentContent" rows="3" cols="58"
																				style="border-style: hidden;"></textarea>
																		</div>
																		<div style="margin: 12px; margin-left: 20px;">
																			<input type="radio" name="commentIsPublic"
																				value="public" checked />&nbsp;공개 &nbsp;&nbsp; <input
																				type="radio" name="commentIsPublic" value="private" />&nbsp;비공개
																		</div>
																		<div style="margin-left: 305px; margin-top: -45px;">
																			<input class="btn btn-common" type="submit"
																				value="등록" style="width: 100px; background: white;">
																			<input class="btn btn-common cancelRecommentA"
																				value="취소" style="width: 100px; background: white;">
																		</div>
																	</div>
																</div>
					...
					<c:if test="${sessionScope.mvo != null}">
						...
						<div class="comments">
							<form action="writeComment.do" method="post" class="recommentFrm">
								<input type="hidden" name="lineNo" value="${i.index}"> <input
									type="hidden" name="storyNo" value="${comment.story.storyNo}">
								<input type="hidden" name="parentCommentNo"
									value="${comment.commentNo}"> <input type="hidden"
									name="parentCommentEmail" value="${comment.member.nickname}">
								...
								<div class="comments">
									<div class="row">
										<div class="col-md-2">${sessionScope.mvo.nickname}</div>
										<div class="col-md-10">
											<div class="comment1">
												<textarea name="commentContent" rows="3" cols="58"
													style="border-style: hidden;"></textarea>
											...
											<div style="margin: 12px; margin-left: 20px;">
												<input type="radio" name="commentIsPublic" value="public"
													checked />&nbsp;공개 &nbsp;&nbsp; <input type="radio"
													name="commentIsPublic" value="private" />&nbsp;비공개
											</div>
											<div style="margin-left: 305px; margin-top: -45px;">
	...
	<footer id="footer" style="width: 100%;">
		<div class="container" style="border-top: 3px solid #ffcccc;">
			<div class="row">
				...
				<div class="col-md-6"
					style="text-align: right; padding-top: 20px; padding-right: 30px;">
					<h2>
					...
					<div class="contact-info bottom">
						...
						<div style="text-align: left;">
							<img src="images/avatar-ahn.png" width="50px" height="50px"
								...
								src="images/avatar-yo.png" width="50px" height="50px"
								class="img-circle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
								src="images/avatar-hyun.png" width="50px" height="50px"
								class="img-circle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
								src="images/avatar-dong.png" width="50px" height="50px"
								class="img-circle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
								src="images/avatar-seo.png" width="50px" height="50px"
								class="img-circle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
								src="images/avatar-ha.png" width="50px" height="50px"
								class="img-circle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img
								src="images/avatar-woo.png" width="50px" height="50px"
								class="img-circle"> <br />
							<p id="avatar">안득호&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								임요섭&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								이태현&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="row">
				...
				<div class="col-md-12" style="text-align: center;">
					<div class="contact-info bottom" style="color: white;">
						...
						670, Daewangpangyo-ro, Bundang-gu, Seongnam-si, Gyeonggi-do,
						Republic of Korea
					</div>
				</div>
				<!-- <div class="col-md-6">
