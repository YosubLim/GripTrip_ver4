...
.order-listOfMember thead th, .order-listOfMember tbody td {
	padding: 10px 10px;
	line-height: 100%;
	text-align: center;
...
.order-listOfMember tbody td {
	font-size: 13px;
}

.order-listOfMember thead th {
	background: #eeeeee;
	...
	<section id="orderList">
		...
		<c:choose>
			<c:when test="${list=='[]'}">
				...
				<br>
				<br>
				<section class="about" style="width: 100%; height: 350px; margin-left: -100px;" >
				   <div class="container">
				      <div class="row center">
				             <div class="col-md-8 col-md-offset-2" align="center">
			                   <img src="images/shopp.png"> <br>                     
				             </div><br><br>
				      </div>
				   </div>
				</section>   
			...
			<c:otherwise>
				...
				<br>
				<!-- TABLE -->
				<table class="order-listOfMember">
						<colgroup>
							<col width="*" />
							<col width="*" />
							<col width="*" />
						...
						<tbody>
							<tr>
								...
								<td>
									<div>
										<span class="orderListInfo"> <img
											src="upload/${orderNo.book.book_picture_url}" />
											<div class="orderListInfoTitle">
												<p>${orderNo.book.book_title}</p>
											</div>
										</span> <span id="orderListInfoTitle"> ${orderNo.book.book_title}
										</span>
									</div>
								</td>
								<td>
									<div>
										<span> ${orderNo.quantity} </span>
									</div>
								</td>
								<td>
									<div>
										<span> ${orderNo.totalPrice}원</span>
									</div>
								</td>
								<td class="orderInfo"><a href="javascript: cancelOrder('${orderNo.orderNo}')" class="btn btn-common" 
								style="font-size: 13px; padding: 15px; ">주문취소</a></td>
								<td class="orderInfo"><a href="showOrderInfo.do?orderNo=${orderNo.orderNo}" class="btn btn-common" 
								style="font-size: 13px; padding: 15px; ">주문내역</a></td>
							</tr>
