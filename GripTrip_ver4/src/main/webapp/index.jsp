...
<head>
	...
	<style type="text/css">
		...
		.col-sm-12, h1, h2, .btn btn-common, p, h3{
...
<c:choose>
    ...
    <section id="services">
        <div class="container">
            <div class="row">
            	<h2 class="title" align="center">G R I P T R I P &nbsp; W R I T E R S</h2>
     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
       ...
       <div class="carousel-inner" role="listbox">
         ...
         <div class="item active">
           <img src="images/carousel001.jpg" alt="place1" width="460" height="345">
           <div class="carousel-caption">
             <h2 style="color: white;">환영합니다!</h2><p>
             <h3>여행을 영원히 보관하는 방법. GripTrip에 있습니다.</h3>
           </div>
         </div>
   
         <div class="item">
           <img src="images/carousel002.jpg" alt="place2" width="460" height="345">
           <div class="carousel-caption">
             <h2 style="color: white;">GripTrip 활용하기 step 1</h2><p>
             <h3>회원가입 후 스토리북과 스토리로 생생한 여행기를 남긴다</h3>
           </div>
         </div>
       
         <div class="item">
           <img src="images/carousel003.jpg" alt="place3" width="460" height="345">
           <div class="carousel-caption">
             <h2 style="color: white;">GripTrip 활용하기 step 2</h2><p>
             <h3>나의 스토리로 가득 채워진 스토리북을 실제 책으로 제작한다</h3>
           </div>
         </div>
   
         <div class="item">
           <img src="images/carousel004.jpg" alt="place4" width="460" height="345">
           <div class="carousel-caption">
             <h2 style="color: white;">GripTrip 활용하기 step 3</h2><p>
      ...
      <!-- video -->
       <section class="indexvideo" style="height: 500px;">
           <div class="container" id="videoContainer">
                <div class="row">
                    <div class="col-md-6">
                         <h3 class="page-header" align="center">Title : 5 tips to improve your writing</h3>
                         <iframe width="550" height="300" src="https://www.youtube.com/embed/GgkRoYPLhts" frameborder="0" allowfullscreen></iframe>
                    </div>
        ...
        <div class="modal-dialog" role="document">
           <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <br/>
                  <div style="text-align: right; font-size: 12px;">이메일을 잊어버리셨나요? <a href="" data-toggle="modal" data-target="#findEmail">이메일 찾기</a></div>
                  <div style="text-align: right; font-size: 12px;">비밀번호를 잊어버리셨나요? <a href="" data-toggle="modal" data-target="#findPassword">비밀번호 찾기</a></div>
                  <br/>
   ...
   <div class="modal fade" id="findEmail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-header" style="background-color: #555; color: #fff;">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               ...
               <div class="input-group" style="width: 400px; margin: auto;">
                  ...
                  <input type="text" class="form-control" name="username" id="username" aria-describedby="basic-addon3" required="required">
               </div><br/>
               <div class="input-group" style="width: 400px; margin: auto;">
                  <span class="input-group-addon" id="basic-addon3">nickname</span>
                  <input type="text" class="form-control" name="nickname" id="nickname" aria-describedby="basic-addon3" required="required">
               </div>
               <br/>
               <br/>
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-primary" id="findEmailButton">찾기</button>
            </div>
          </div>
        </div>
   </div>
   ...
   <div class="modal fade" id="findPassword" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-header" style="background-color: #555; color: #fff;">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                 <h4 class="modal-title" id="myModalLabel">Find Password Form</h4>
               </div>
               <div class="modal-body">
                  <br/>
                  <div id="loginResultView" style="text-align: center;"></div>
            ...
            <div class="modal-footer" id="findPasswordFooter">
               <button type="button" class="btn btn-primary" id="findPasswordButton">찾기</button>
            </div>
          </div>
        </div>
   </div>
		        ...
		        <div class="container">
		           <div class="row center">
		              <div class="col-md-8 col-md-offset-2" align="center">
		                 <img src="images/fbook.png" alt="스토리 북 쓰기">
		                 <br><br>
		                 <!-- <h5 class="lead"> "첫 여행 스토리 북을 만들어 보세요" </h5> -->
		              <br>
		              <a href="book_Insert.jsp" class="btn btn-common" style="width: 290px;">스토리 북 쓰기</a>
		              </div><br><br>
		           </div>
		        </div>
		     </section>   
